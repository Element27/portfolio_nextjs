...
interface IconGitProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconGit({ props, className }: IconGitProps) {
  return (
    <svg
      className={className}
      fill="currentColor"
...
interface IconLogoJavascriptProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconLogoJavascript({
  props,
  className,
}: IconLogoJavascriptProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 512 512"
...
export function IconNextjs({ props, className }: IconNextjsProps) {
  return (
    <svg
      className={className}
      fill="none"
...
interface IconHtml5Props {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconHtml5({ props, className }: IconHtml5Props) {
  return (
    <svg
      className={className}
...
interface IconBxlCss3Props {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconBxlCss3({ props, className }: IconBxlCss3Props) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
interface IconTailwindcssProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconTailwindcss({ props, className }: IconTailwindcssProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
interface IconTypescriptProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconTypescript({ props, className }: IconTypescriptProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
interface IconAdobephotoshopProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconAdobephotoshop({
  props,
  className,
}: IconAdobephotoshopProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
interface IconGolangProps {
  props?: React.SVGProps<SVGSVGElement>;
  className?: string;
}

export function IconGolang({ props, className }: IconGolangProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 640 512"
...
export function IconReact({ props, className }: IconReactProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 512 512"
